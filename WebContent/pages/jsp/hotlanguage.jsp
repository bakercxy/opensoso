...
<body style="background: #F5F5F5">
			...
			<div class="col-lg-10 ">
				<div class="myjumbotron2">
					<div class="row text-center" style="height: 1000px">
						<div class="col-lg-12">
							<h1 class="text-oringe text-center">Hot Languages Words</h1>
							<!--操作选择-->
								...
								<form class="form-inline" role="form">
									...
									<div class="form-group">
										<label for="frequency" class="control-label">Least
											Language Frequency</label> <select class="form-control"
											id="frequency">
											<option>All</option>
											<option>1%</option>
											<option>0.5%</option>
							...
							<div class="row row-lg-offset-3">
								<div class="col-lg-12">
									...
									<div class="row row-lg-offset-2">
										...
										The hot languages words graph
											describes the most popular development languages in Github
											repositories in the recent three years. The statistics we
											calculated from nearly 2.5 million repositories includes
											almost 200 types of languages, in which JavaScript, Java and
											Ruby are the top 3 development languages the developers would
											like to use in their projects. In addition, the usage percent
											of Python, PHP, CSS,C, C++, Objective-C, Shell, C#, R and Go are all
											above 1% in the open source community.</div>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript">
		...
		function sendRequest() {
			...
			var url = "queryword.do?type=lang&" + "freq="
					+ $('#frequency').val() + "&minsize=" + $('#minsize').val()
					+ "&maxsize=" + $('#maxsize').val();
