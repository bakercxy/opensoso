		...
		<div class="row myjumbotron2">
				...
				<div class="myjumbotron4">
					<div class="row" style="height: 1000px">
						<ul class="nav nav-sidebar">
							<h4 class="text-oringe text-center">SOCIAL GRAPHS</h4>
							<li class="text-left"><a href="attendancegraph.html">▪ Attendance Graph</a></li>
							<li class="text-left"><a href="watch.html">▪ Watch Graph</a></li>
							<li class="text-left"><a href="follower.html">▪ Follower Graph</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-10">
				<div class="myjumbotron2">
					<div class="row" style="height: 1000px">
						<div class="col-lg-12">
							<h1 class="text-oringe text-center">Attendance Graph</h1>
...
#graph-container {
	...
	position: absolute;
									...
									<div class="row row-lg-offset-2">
										...
										The attendance graph shows the popularity
											of repositories. We divided the repositories into four classes
											based on the amount of users. We used different colors and
											size of repository nodes to denote the different class of
											repository. According to the popularity from high to low,we
											use purple, dark blue, green and yellow to render the
											repository nodes . All of the users nodes are rendered in
											light blue.</div>
									</div>
								</div>
							</div>
	...
	<script>
		...
		sigma.parsers.gexf('./datas/gaze.gexf', {
