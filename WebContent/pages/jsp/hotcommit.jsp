...
<body style="background: #F5F5F5">
			...
			<div class="col-lg-10 ">
				<div class="myjumbotron2">
					<div class="row text-center" style="height: 1000px">
						<div class="col-lg-12">
							<h1 class="text-oringe text-center">Hot Commits Words</h1>
							<!--操作选择-->
								...
								<div class="col-lg-12">
									...
									<div class="row row-lg-offset-2">
										<div class="col-lg-12 text-left" style="font-size: 16px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
											The hot commits words graph describes the most common and
											popular words the developers always used when they committed
											what they had done in Github repositories in the recent three
											years. we calculated from nearly 2.5 million repositories and
											gave the statistics that there're nearly 120 words have a
											high frequency, in which "line", "http", "test" are the top 3
											development words the developers would like to use in their
											commits. In addition, the usage percent of "comment", "code",
											"error", "function", "method", "parameter", "exception" and
											other six words are all above 1% in the open source community.</div>
									</div>
								</div>
							</div>
						</div>
	...
	<script type="text/javascript">
		...
		function sendRequest() {
			...
			var url = "queryword.do?type=commit&" + "freq="
